...
import {
  ...
  getPowData,
  setPowData,
} from "../../../shared/session/auth-session";
    ...
    try {
      ...
      setState({
        ...
        errorMessage: toDisplayError(
          error,
          "РќРµ СѓРґР°Р»РѕСЃСЊ РёРЅРёС†РёР°Р»РёР·РёСЂРѕРІР°С‚СЊ Р°РІС‚РѕСЂРёР·Р°С†РёСЋ.",
        ),
      });
    }
    ...
    async function completeAuth() {
      try {
        ...
        setState({
          ...
          errorMessage: toDisplayError(
            error,
            "РќРµ СѓРґР°Р»РѕСЃСЊ Р·Р°РІРµСЂС€РёС‚СЊ Р°РІС‚РѕСЂРёР·Р°С†РёСЋ.",
          ),
        });
      }
    }
  ...
  const acceptTerms = useCallback(async () => {
    ...
    if (!registrationToken) {
      setState({
        status: "error",
        errorMessage:
          "РЎРµСЃСЃРёСЏ СЂРµРіРёСЃС‚СЂР°С†РёРё РёСЃС‚РµРєР»Р°. РќР°С‡РЅРёС‚Рµ РІС…РѕРґ Р·Р°РЅРѕРІРѕ.",
      });
      return;
    }
