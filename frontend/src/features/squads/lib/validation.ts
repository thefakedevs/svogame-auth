...
export function hasInvalidSquadNameByConfig(value: string, config: ProfileDashboardData['squadConfig']) {
...
export async function validateSquadImageByConfig(file: File, config: ProfileDashboardData['squadConfig']) {
