    ...
    <section className="card profile-panel">
      ...
      <div className="profile-member-list">
        {visibleMembers.map((member) => {
          ...
          const isRevokingInvite =
            pendingActionKey !== null && processingActionKey === pendingActionKey;
      ...
      {isLeader && memberToKick ? (
        <AppPortal>
          <div
            ...
            role="presentation"
            onClick={() => !processingActionKey && setMemberToKick(null)}
          >
            <div
              className="ui-modal"
              role="dialog"
            ...
            >
              <div className="ui-modal-header">
                ...
                <button
                  ...
                  disabled={Boolean(processingActionKey)}
                >
                  ×
                </button>
              </div>
              <div className="ui-modal-body">
                <p>
                  Участник <strong>{memberToKick.username}</strong> будет исключен из сквада.
