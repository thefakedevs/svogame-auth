  ...
  return (
    <section className="card profile-panel">
      ...
      <div className="profile-stack">
        ...
        <div className="profile-inline-card">
          <strong>Лидер</strong>
          <span className="profile-subtle">{data.squadMembers.find((member) => member.isLeader)?.username ?? 'Нет данных'}</span>
        </div>
        {isLeader ? (
          <div className="profile-actions">
          ...
          <div className="ui-modal-backdrop" role="presentation" onClick={() => !isDeletingSquad && setIsDeleteModalOpen(false)}>
            <div className="ui-modal" role="dialog" aria-modal="true" aria-labelledby="delete-squad-modal-title" onClick={(event) => event.stopPropagation()}>
              <div className="ui-modal-header">
                ...
                <button className="ui-modal-close" type="button" aria-label="Закрыть" onClick={() => setIsDeleteModalOpen(false)} disabled={isDeletingSquad}>
                  ×
                </button>
              </div>
