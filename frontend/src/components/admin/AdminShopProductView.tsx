...
export default function AdminShopProductView({
  token,
  productId,
}: {
  token: string;
        ...
        {product ? (
          <>
            <div className="admin-section-head admin-detail-hero">
              ...
              <span
                className={`ui-badge ${product.isAvailableNow ? "ui-badge-success" : "ui-badge-warning"}`}
              >
            ...
            <dl className="admin-kv admin-kv--compact">
              ...
              <div>
                <dt>Витрина</dt>
                <dd>
                  {product.isAvailableNow ? "Доступен сейчас" : "Недоступен по расписанию/флагам"}
                </dd>
              </div>
            </dl>
            ...
            <div className="admin-shop-list-toolbar admin-spaced-toolbar">
              <label className="admin-shop-field admin-filter-label admin-filter-label--wide">
                <span className="admin-inline-muted">
                  Параметр locale при загрузке (опционально)
                </span>
                <input
                  className="ui-input"
                  value={localeInputDraft}
                  onChange={(e) => setLocaleInputDraft(e.target.value)}
                  placeholder="ru-RU"
                />
              </label>
              <button
                ...
                onClick={() => setLocaleForFetch(localeInputDraft)}
              >
                Загрузить с локалью
              </button>
            </div>
            ...
            <div className="admin-asset-flags admin-shop-form-flags admin-asset-flags--radios">
              <fieldset className="ui-radio-group admin-asset-flag-fieldset">
                ...
                <label className="ui-radio">
                  <input
                    type="radio"
                    name="admin-shop-product-active"
                    checked={isActive}
              ...
              <fieldset className="ui-radio-group admin-asset-flag-fieldset">
                ...
                <label className="ui-radio">
                  <input
                    type="radio"
                    name="admin-shop-product-public"
                    checked={isPublic}
