            ...
            <article className="admin-asset-card admin-spaced-form">
              ...
              <div className="admin-asset-edit-grid">
                <input
                  ...
                  onChange={(event) =>
                    setDraft((prev) => (prev ? { ...prev, displayName: event.target.value } : prev))
                  }
                ...
                {asset.assetKind === "skin" ? (
                  <>
                    <select
                      ...
                      onChange={(event) =>
                        setDraft((prev) =>
                          prev ? { ...prev, rarity: event.target.value as SkinRarity | "" } : prev,
                        )
                      }
                    >
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setDraft((prev) =>
                          prev ? { ...prev, weaponKey: event.target.value } : prev,
                        )
                      }
                ...
                <fieldset className="ui-radio-group admin-asset-flag-fieldset">
                  ...
                  <label className="ui-radio">
                    <input
                      ...
                      checked={!draft.isActive}
                      onChange={() =>
                        setDraft((prev) => (prev ? { ...prev, isActive: false } : prev))
                      }
                    />
                    <span className="ui-radio-mark" aria-hidden />
                    <span>Неактивен</span>
                ...
                <fieldset className="ui-radio-group admin-asset-flag-fieldset">
                  ...
                  <label className="ui-radio">
                    <input
                      ...
                      onChange={() =>
                        setDraft((prev) => (prev ? { ...prev, isPublic: true } : prev))
                      }
                    />
                    <span className="ui-radio-mark" aria-hidden />
                    <span>Публичный</span>
                  ...
                  <label className="ui-radio">
                    <input
                      ...
                      checked={!draft.isPublic}
                      onChange={() =>
                        setDraft((prev) => (prev ? { ...prev, isPublic: false } : prev))
                      }
                    />
                    <span className="ui-radio-mark" aria-hidden />
                    <span>Скрытый</span>
                ...
                <fieldset className="ui-radio-group admin-asset-flag-fieldset">
                  ...
                  <label className="ui-radio">
                    <input
                      ...
                      onChange={() =>
                        setDraft((prev) => (prev ? { ...prev, isUserPurchasable: true } : prev))
                      }
                    />
                    <span className="ui-radio-mark" aria-hidden />
                  ...
                  <label className="ui-radio">
                    <input
                      ...
                      checked={!draft.isUserPurchasable}
                      onChange={() =>
                        setDraft((prev) => (prev ? { ...prev, isUserPurchasable: false } : prev))
                      }
                    />
                    <span className="ui-radio-mark" aria-hidden />
              ...
              <textarea
                ...
                onChange={(event) =>
                  setDraft((prev) => (prev ? { ...prev, metadataText: event.target.value } : prev))
                }
