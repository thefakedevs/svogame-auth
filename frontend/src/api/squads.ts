...
export function uploadSquadImage(
  token: string,
  squadId: string,
  file: File,
...
export function kickSquadMember(
  token: string,
  squadId: string,
  userId: string,
): Promise<SquadActionResponse> {
...
export function createSquadInvite(
  token: string,
  squadId: string,
  userId: string,
): Promise<SquadInviteResponse> {
